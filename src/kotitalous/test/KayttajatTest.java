 ...
 * @version 2022.04.22 10:52:37 // Generated by ComTest
 *
 */
...
public class KayttajatTest {
   ...
   */
  @Test
  public void testLueTiedostosta150() throws SailoException {    // Kayttajat: 150
    Kayttajat kayttajat = new Kayttajat(); 
    ...
    fail("Kayttajat: 161 Did not throw SailoException");
    ...
    assertEquals("From: Kayttajat line: 169", aada1.toString(), i.next().toString()); 
    assertEquals("From: Kayttajat line: 170", aada2.toString(), i.next().toString()); 
    assertEquals("From: Kayttajat line: 171", aada3.toString(), i.next().toString()); 
    assertEquals("From: Kayttajat line: 172", false, i.hasNext()); 
    kayttajat.lisaa(aada1); 
    kayttajat.tallenna(tiedNimi); 
    assertEquals("From: Kayttajat line: 175", true, ftied.delete()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testIterator225() throws SailoException {    // Kayttajat: 225
    Kayttajat kayttajat = new Kayttajat(); 
    ...
    assertEquals("From: Kayttajat line: 242", tulos, ids.toString()); 
    ids = new StringBuffer(30); 
    for (Iterator<Kayttaja> i = kayttajat.iterator(); i.hasNext(); ) {
    Kayttaja k = i.next(); 
    ids.append(" " + k.getKid()); 
    }
    assertEquals("From: Kayttajat line: 250", tulos, ids.toString()); 
    Iterator<Kayttaja> i = kayttajat.iterator(); 
    assertEquals("From: Kayttajat line: 253", true, i.next() == aada1); 
    assertEquals("From: Kayttajat line: 254", true, i.next() == aada2); 
    assertEquals("From: Kayttajat line: 255", true, i.next() == aada1); 
    try {
    i.next(); 
    fail("Kayttajat: 257 Did not throw NoSuchElementException");
