 ...
 * @version 2022.04.22 17:38:00 // Generated by ComTest
 *
 */
...
public class KayttajatTest {
  ...
  public void testPoista115() {    // Kayttajat: 115
    ...
    kt.poista(k); 
    assertEquals("From: Kayttajat line: 123", 2, kt.getLkm()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLueTiedostosta177() throws SailoException {    // Kayttajat: 177
    Kayttajat kayttajat = new Kayttajat(); 
    ...
    fail("Kayttajat: 188 Did not throw SailoException");
    ...
    assertEquals("From: Kayttajat line: 196", aada1.toString(), i.next().toString()); 
    assertEquals("From: Kayttajat line: 197", aada2.toString(), i.next().toString()); 
    assertEquals("From: Kayttajat line: 198", aada3.toString(), i.next().toString()); 
    assertEquals("From: Kayttajat line: 199", false, i.hasNext()); 
    kayttajat.lisaa(aada1); 
    kayttajat.tallenna(tiedNimi); 
    assertEquals("From: Kayttajat line: 202", true, ftied.delete()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testIterator252() throws SailoException {    // Kayttajat: 252
    Kayttajat kayttajat = new Kayttajat(); 
    ...
    assertEquals("From: Kayttajat line: 269", tulos, ids.toString()); 
    ids = new StringBuffer(30); 
    for (Iterator<Kayttaja> i = kayttajat.iterator(); i.hasNext(); ) {
    Kayttaja k = i.next(); 
    ids.append(" " + k.getKid()); 
    }
    assertEquals("From: Kayttajat line: 277", tulos, ids.toString()); 
    Iterator<Kayttaja> i = kayttajat.iterator(); 
    assertEquals("From: Kayttajat line: 280", true, i.next() == aada1); 
    assertEquals("From: Kayttajat line: 281", true, i.next() == aada2); 
    assertEquals("From: Kayttajat line: 282", true, i.next() == aada1); 
    try {
    i.next(); 
    fail("Kayttajat: 284 Did not throw NoSuchElementException");
