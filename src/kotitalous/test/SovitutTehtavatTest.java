 ...
 * @version 2022.04.22 17:56:09 // Generated by ComTest
 *
 */
...
public class SovitutTehtavatTest {
  ...
  // Generated by ComTest BEGIN
  /** testAnnaSovitutKayttajat123 */
  @Test
  public void testAnnaSovitutKayttajat123() {    // SovitutTehtavat: 123
    ...
    assertEquals("From: SovitutTehtavat line: 162", 1, loytyneet.size()); 
    assertEquals("From: SovitutTehtavat line: 163", true, loytyneet.get(0) == st1); 
    loytyneet = steet.annaSovitutTehtavat(k2); 
    assertEquals("From: SovitutTehtavat line: 166", 1, loytyneet.size()); 
    assertEquals("From: SovitutTehtavat line: 167", true, loytyneet.get(0) == st2); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLueTiedostosta200() throws SailoException {    // SovitutTehtavat: 200
    SovitutTehtavat steet = new SovitutTehtavat(); 
    SovittuTehtava st1 = new SovittuTehtava(); 
    SovittuTehtava st2 = new SovittuTehtava(); 
    SovittuTehtava st3 = new SovittuTehtava(); 
    ...
    fail("SovitutTehtavat: 212 Did not throw SailoException");
    ...
    assertEquals("From: SovitutTehtavat line: 240", st1.toString(), i.next().toString()); 
    assertEquals("From: SovitutTehtavat line: 241", st2.toString(), i.next().toString()); 
    assertEquals("From: SovitutTehtavat line: 242", st3.toString(), i.next().toString()); 
    assertEquals("From: SovitutTehtavat line: 243", false, i.hasNext()); 
    steet.lisaa(st1); 
    steet.tallenna(tiedNimi); 
    assertEquals("From: SovitutTehtavat line: 246", true, ftied.delete()); 
  } // Generated by ComTest END
}