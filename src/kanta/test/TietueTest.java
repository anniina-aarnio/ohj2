 ...
 * @version 2022.04.13 14:09:00 // Generated by ComTest
 *
 */
...
public class TietueTest {
  ...
  public void testString70() {    // Tietue: 70
    Kayttaja k = new Kayttaja(); 
    assertEquals("From: Tietue line: 72", "Anna kokonaisluku", k.aseta(2, "kissa")); 
  ...
  /** testString102 */
  @Test
  public void testString102() {    // Tietue: 102
    Kayttaja k = new Kayttaja(); 
    k.parse("  3 |   Aada    | 35   "); 
    assertEquals("From: Tietue line: 105", "3|Aada|35", k.toString());  // esimerkissä oli =R= ja tolppia ennen aina \\|
  } // Generated by ComTest END
}